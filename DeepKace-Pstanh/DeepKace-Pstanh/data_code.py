...
#########################one_hot #########################
    def one_hot(self):
        ...
        self.out_file(one_hot,'one_hot_test')
        print(' ______ one_hot_test is done! ___ the shape is ',one_hot.shape,'_______')
        #return one_hot
######################### blosum62 #########################
    def blosum(self):
        blosum62 = {
        ...
        self.out_file(blosum,'blosum_test')
        print(' ______ blosum_test is done! ___ the shape is ',blosum.shape,'______')
        #return blosum
...
########################### AAindex ############################
    def AAindex(self):
        ...
        self.out_file(AAindex, 'AAindex_test')
        print(' ______ AAindex_test is done! ___ the shape is ', AAindex.shape, '______')
        # return AAindex
...
#################### SD ######################
    def SD(self):
        ...
        self.out_file(SD, 'SD_test')
        print(' ______ SD_test is done! ___ the shape is ', SD.shape, '______')
...
#################### PC ######################
    def PC(self):
        ...
        self.out_file(PC, 'PC_test')
        print(' ______ PC_test is done! ___ the shape is ', PC.shape, '______')
...
#################### EGB ######################
    def EGB(self):
        ...
        self.out_file(EGB, 'EGB_test')
        print(' ______ EGB_test is done! ___ the shape is ', EGB.shape, '______')
...
#################### PAM ######################
    def PAM(self):
        ...
        self.out_file(PAM, 'PAM_test')
        print(' ______ PAM_test is done! ___ the shape is ', PAM.shape, '______')
...
#################### Zscales ######################
    def Zscales(self):
        ...
        self.out_file(Zscales, 'Zscales_test')
        print(' ______ Zscales_test is done! ___ the shape is ', Zscales.shape, '______')
...
if __name__ == '__main__':
    ...
    data = Data_code(in_path='test_set.txt')
