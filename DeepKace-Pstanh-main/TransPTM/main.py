...
if __name__ == '__main__':
    ...
    for seq_len in len_ls:
        ...
        for i in range(1):
            ...
            print(test_metrics)
            print('test loss: {:5f}; test acc: {:4f}; test auroc: {:4f}; test auprc: {:.4f}; test mcc: {:.4f}; test sn: {:4f}; test sp: {:4f}; test f1: {:.4f}'.format(
                test_metrics.loss, test_metrics.acc, test_metrics.auroc, test_metrics.auprc, test_metrics.mcc, test_metrics.sn, test_metrics.sp, test_metrics.f1))
            ...
            if args.save:
                ...
                save_path = os.path.join(save_dir,
                                         '{}_acc{:.4f}_roc{:.4f}_prc{:.4f}_f1{:.4}_mcc{:.4}.pt'.format(i,
                                                                                      test_metrics.acc,
                                                                                      test_metrics.auroc,
                                                                                      test_metrics.auprc,
                                                                                      test_metrics.f1,
