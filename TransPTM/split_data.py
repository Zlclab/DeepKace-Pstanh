...
def split_data(data, val_size, test_size):
    ...
    train_pos, test_pos = train_test_split(pos_data, test_size=test_size)
    train_neg, test_neg = train_test_split(neg_data, test_size=test_size)

    train_pos, val_pos = train_test_split(train_pos, test_size=val_size)
...
if __name__ == '__main__':
    '''fasta_ls = [(1, f'21p.fasta'), (0, f'21n.fasta')]
    len_ls = [21]
    record_ls = []
